...
cat("1. Performance: The Lasso model did not provide a significant improvement in APSE on the validation set compared to OLS, suggesting that overfitting was not a major issue.\n")
cat("2. Parsimony: The Lasso model retained nearly all predictors (shrinkage was minimal), confirming that the variables selected in our OLS model (Trend, Seasonality, Fourier terms) are all relevant.\n")
cat("3. Interpretability: The OLS model provides standard confidence intervals and p-values, which are valuable for inference.\n\n")
...
saveRDS(final_train_data, "final_train_data.rds")
saveRDS(final_test_data, "final_test_data.rds")
saveRDS(poly_basis_final, "poly_basis_final.rds")
saveRDS(test_data, "test_data_processed.rds")
saveRDS(lam, "boxcox_lambda.rds")
